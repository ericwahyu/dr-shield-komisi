    ...
    <ul class="menu-inner py-1">
       <!-- Dashboards -->
        ...
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text" data-i18n="Data Sales">Data Sales</span>
        </li>
        <li class="menu-item {{ Request::is('*sales/daftar*', '*sales/batas-bawah-target*') ? 'active' : '' }}">
            <a href="{{ route('sales.list') }}" class="menu-link">
                <i class="menu-icon fa-regular fa-home-alt fa-fw me-2"></i>
                <div class="text-truncate" data-i18n="Daftar Sales">Daftar Sales</div>
            </a>
        </li>
