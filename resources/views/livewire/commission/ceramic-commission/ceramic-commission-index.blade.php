                ...
                <tbody>
                    @forelse ($sales as $result)
                        ...
                        <tr wire:key='{{ rand() }}'>
                            ...
                            <td rowspan="{{ count($lower_limit_commissions) > 0 ? count($lower_limit_commissions) : ''  }}" class="text-center">{{ $sales?->currentPage() * $perPage - $perPage + $loop->iteration }}</td>
