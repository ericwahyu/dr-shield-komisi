...
use App\Services\Export\Commission\Ceramic\ExportCeramicCommissionVersion2;
use Illuminate\Contracts\View\View;
use Maatwebsite\Excel\Concerns\FromCollection;
use Maatwebsite\Excel\Concerns\FromView;

class CeramicCommissionVersion2 implements FromView
{
   protected $export_month, $ExportCeramicCommissionVersion1;
    ...
    public function __construct($export_month)
    {
        ...
        $this->ExportCeramicCommissionVersion1 = new ExportCeramicCommissionVersion2($export_month);
    }
