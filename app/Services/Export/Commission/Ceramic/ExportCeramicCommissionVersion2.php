...
class ExportCeramicCommissionVersion2
{
    ...
    public function commissionSales($user_id)
    {
        ...
        })->where('year', (int)Carbon::parse($this->export_month)->format('Y'))->where('month', (int)Carbon::parse($this->export_month)->format('m'))->where('version', 2)->first();
