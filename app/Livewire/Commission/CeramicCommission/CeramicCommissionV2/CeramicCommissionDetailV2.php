...
class CeramicCommissionDetailV2 extends Component
{
    ...
    {
        return view('livewire.commission.ceramic-commission.ceramic-commission-v2.ceramic-commission-detail-v2', [
    ...
    public function mount($sales_id, $month_commission)
    {
        ...
        })->where('year', (int)Carbon::parse($month_commission)?->format('Y'))->where('month', (int)Carbon::parse($month_commission)?->format('m'))->whereNull('category_id')->where('version', 2)->first();
